...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/zalZEEY/NeonBot/)

[![Run on Repl.it](https://repl.it/badge/github/justpiple/whatsapp-bot)](https://repl.it/github/Zeey/NeonBot)


### Install ⬇️

```bash
> git clone https://github.com/zalZEEY/NeonBot/
> cd whatsapp-bot
> npm i
```
